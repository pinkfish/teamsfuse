              ...
              child: BlocConsumer(
                ...
                listener: (BuildContext context, SingleTeamState state) {
                  ...
                  if (state is SingleTeamLoaded &&
                    ...
                    setState(() {
                      expandedPanels.add(state.team.currentSeason);
                    });
  ...
  Widget _getDataTableByTeam(Team team) {
    ...
    if (team.currentSeason != null &&
      ...
      rows.addAll(sortedGames
          .where((Game g) => g.seasonUid == team.currentSeason)
          .map(_gameDataRow));
    }
          ...
          DataColumn(
            ...
            onSort: (int index, bool ascending) {
              ...
              sortedGames.sort((Game a, Game b) {
                var cmp = a.seasonUid.compareTo(b.seasonUid);
                if (cmp == 0) {
                  cmp = a.opponentUid.compareTo(b.opponentUid);
      ...
      cells: [
        ...
        DataCell(
          Container(
            width: 10,
            child: Text(
              s.playersData[widget.playerUid].summary.basketballSummary.points
                  .toString(),
              style: style,
            ),
          ),
        ...
        DataCell(
          Text(
            _getMadeMissed(
                s.playersData[widget.playerUid].summary.basketballSummary.one),
            style: style,
          ),
        ),
        DataCell(
          Text(
            _getMadeMissed(
                s.playersData[widget.playerUid].summary.basketballSummary.two),
            style: style,
          ),
        ),
        DataCell(
          Text(
            _getMadeMissed(s
                .playersData[widget.playerUid].summary.basketballSummary.three),
            style: style,
          ),
        ),
        DataCell(
          Text(
            s.playersData[widget.playerUid].summary.basketballSummary
                .offensiveRebounds
                .toString(),
            style: style,
          ),
        ...
        DataCell(
          Text(
            s.playersData[widget.playerUid].summary.basketballSummary.steals
                .toString(),
            style: style,
          ),
        ),
        DataCell(
          Text(
            s.playersData[widget.playerUid].summary.basketballSummary.blocks
                .toString(),
            style: style,
          ),
        ),
        DataCell(
          Text(
            s.playersData[widget.playerUid].summary.basketballSummary.turnovers
                .toString(),
            style: style,
          ),
        ),
        DataCell(
          Text(
            s.playersData[widget.playerUid].summary.basketballSummary.fouls
                .toString(),
            style: style,
          ),
        ),
