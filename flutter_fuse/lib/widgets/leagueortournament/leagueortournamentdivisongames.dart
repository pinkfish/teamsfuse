              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Align(
                    ...
                    child: FlatButton(
                      onPressed: () =>
                          _addGame(bloc.leagueDivisonUid, divisonState),
  ...
  Widget build(BuildContext context) {
    ...
    return SingleLeagueOrTournamentDivisonProvider(
      ...
      builder: (context, divisonBloc) {
        ...
        return BlocBuilder(
          cubit: divisonBloc,
          builder: (context, divisonState) => Container(
            alignment: Alignment.topLeft,
            margin: EdgeInsets.all(5.0),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              ...
              children: <Widget>[
                ListTile(
                  ...
                  title: LeagueOrTournamentName(
                    divisonState.division.leagueOrTournamentUid,
                    ...
                    children: [
                      LeagueOrTournamentSeasonName(
                          leagueOrTournmentSeasonUid:
                              divisonState.divison.leagueOrTournamentSeason),
                      Text(
                  ...
                  child: Scrollbar(
                    child: SingleChildScrollView(
                      child: SingleLeagueOrTournamentProvider(
                        leagueUid: divisonState.divison.leagueOrTournmentUid,
