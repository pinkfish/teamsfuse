...
class AddInviteToTeamScreen extends StatefulWidget {
  final String _inviteUid;

  AddInviteToTeamScreen(this._inviteUid);

  @override
  AddInviteToTeamScreenState createState() {
    return new AddInviteToTeamScreenState();
  }
}

class AddInviteToTeamScreenState extends State<AddInviteToTeamScreen> {
  ...
  void _savePressed() async {
    if (_formKey.currentState.validate()) {
      ...
      await Future.forEach(_checked, (String name) async {
        ...
        await UserDatabaseData.instance.acceptInvite(inv, playerUid: uid, name: _data[name]);
      });
