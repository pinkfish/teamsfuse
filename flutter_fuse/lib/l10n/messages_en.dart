...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m2(ptsFor, ptsAgainst, overtimeFor, overtimeAgainst) =>
      "${ptsFor} - ${ptsAgainst} (Overtime ${overtimeFor} - ${overtimeAgainst})";

  static m3(ptsFor, ptsAgainst, overtimeFor, overtimeAgainst, penaltyFor,
          penaltyAgainst) =>
      "${ptsFor} - ${ptsAgainst} (Overtime ${overtimeFor} - ${overtimeAgainst})(Penalty ${penaltyFor} - ${penaltyAgainst})";

  static m4(ptsFor, ptsAgainst, penaltyFor, penaltyAgainst) =>
      "${ptsFor} - ${ptsAgainst} (Penalty ${penaltyFor} - ${penaltyAgainst})";

  static m5(teamName, season, league) =>
      "Are you sure you want to create a team ${teamName} with a season of ${season} for the league ${league}.  This is not possible to undo?";
  ...
  static m8(playerName) =>
      "Do you want to delete the invite to follow ${playerName}?";

  static m9(teamName, playerName) =>
      "Do you want to delete the invite to ${teamName} for ${playerName}?";

  static m10(leagueName) =>
      "Do you want to delete the invite to be in the league ${leagueName}?";

  static m11(leagueName, leagueTeamName) =>
      "Do you want to delete the invite to be in the league ${leagueName} with team ${leagueTeamName}?";

  static m12(displayName) => "Delete club member ${displayName}?";

  static m13(playerName) =>
      "Do you want to delete your connection to ${playerName}?";
  ...
  static m19(name, time, endTime, tzShortName) =>
      "NOW! ${name} ${time} - ${endTime}  (${tzShortName})";

  static m20(name, time, tzShortName) =>
      "NOW! ${name} ${time} (${tzShortName})";

  static m21(time, endTime) => "NOW! Event ${time} - ${endTime}";

  static m22(time, endTime, tzShortName) =>
      "NOW! Event ${time} - ${endTime} (${tzShortName})";
  ...
  static m27(name, time, endTime, tzShortName) =>
  ...
  static m30(time, endTime, tzShortName) =>
      "Event ${time} - ${endTime} (${tzShortName})";

  static m31(time, tzShortName) => "Event ${time} (${tzShortName})";

  static m32(
          resultString, homeFor, homeAgainst, overtimeFor, overtimeAgainst) =>
      "${resultString}\nHome: ${homeFor} Away: ${homeAgainst}\nOvertime Home: ${overtimeFor} Away: ${overtimeAgainst}";

  static m33(resultString, homeFor, homeAgainst, overtimeFor, overtimeAgainst,
          penaltyFor, penaltyAgainst) =>
      "${resultString}\nHome: ${homeFor} Away: ${homeAgainst}\nOvertime Home: ${overtimeFor} Away: ${overtimeAgainst}Penalty Home: ${penaltyFor} Away: ${penaltyAgainst}";

  static m34(resultString, homeFor, homeAgainst, penaltyFor, penaltyAgainst) =>
      "${resultString}\nHome: ${homeFor} Away: ${homeAgainst}\nPenalty Home: ${penaltyFor} Away: ${penaltyAgainst}";

  static m35(ptsFor, ptsAgainst, result) =>
  ...
  static m39(resultString, ptsFor, ptsAgainst) =>
      "${resultString}\nHome: ${ptsFor} Away: ${ptsAgainst}";

  static m40(time, endTime, opponent) =>
      "NOW! ${time} - ${endTime} cs ${opponent}";

  static m41(time, endTime, tzShortName, opponent) =>
      "NOW! ${time} - ${endTime} (${tzShortName}) vs ${opponent}";

  static m42(time, tzShortName, opponent) =>
      "NOW! ${time} (${tzShortName}) vs ${opponent}";

  static m43(time, opponent) => "NOW! ${time} vs ${opponent}";

  static m44(time, endTime, opponent) => "${time} - ${endTime} vs ${opponent}";

  static m45(time, endTime, tzShortName, opponent) =>
      "${time} - ${endTime} (${tzShortName}) vs ${opponent}";

  static m46(time, tzShortName, opponent) =>
      "${time} (${tzShortName}) vs ${opponent}";

  static m47(time, opponent) => "${time} vs ${opponent}";
  ...
  static m55(num) =>
      "${Intl.plural(num, zero: 'No teams', one: 'One team', other: '${num} teams')}";

  static m56(num) =>
      "${Intl.plural(num, one: 'One user', other: '${num} users')}";
  ...
  static m65(ptsFor, ptsAgainst) =>
      "Start break Score: ${ptsFor} - ${ptsAgainst}";

  static m66(ptsFor, ptsAgainst) =>
      "Start overtime break Score: ${ptsFor} - ${ptsAgainst}";

  static m67(periodNumber, ptsFor, ptsAgainst) =>
      "Start overtime ${periodNumber} Score: ${ptsFor} - ${ptsAgainst}";

  static m68(ptsFor, ptsAgainst) =>
      "Start penalty Score: ${ptsFor} - ${ptsAgainst}";

  static m69(periodNumber, ptsFor, ptsAgainst) =>
      "Start period ${periodNumber} Score: ${ptsFor} - ${ptsAgainst}";

  static m70(ptsFor, ptsAgainst) =>
      "Stop break Score: ${ptsFor} - ${ptsAgainst}";

  static m71(ptsFor, ptsAgainst) =>
      "Stop overttime break Score: ${ptsFor} - ${ptsAgainst}";

  static m72(periodNumber, ptsFor, ptsAgainst) =>
      "Stop overttime ${periodNumber} Score: ${ptsFor} - ${ptsAgainst}";

  static m73(ptsFor, ptsAgainst) =>
      "Stop penalty Score: ${ptsFor} - ${ptsAgainst}";

  static m74(periodNumber, ptsFor, ptsAgainst) =>
      "Stop period ${periodNumber} Score: ${ptsFor} - ${ptsAgainst}";

  static m75(name) =>
      "This will follow ${name} and allow you to see which games they are in and all the teams they are in.  Please setup your relationship with the player and save.";

  static m76(ptsFor, ptsAgainst, overtimeFor, overtimeAgainst) =>
      "Playing ${ptsFor} - ${ptsAgainst} (Overtime ${overtimeFor} - ${overtimeAgainst})";

  static m77(ptsFor, ptsAgainst, overtimeFor, overtimeAgainst, penaltyFor,
          penaltyAgainst) =>
      "Playing ${ptsFor} - ${ptsAgainst} (Overtime ${overtimeFor} - ${overtimeAgainst})(Penalty ${penaltyFor} - ${penaltyAgainst})";

  static m78(ptsFor, ptsAgainst, penaltyFor, penaltyAgainst) =>
      "Playing ${ptsFor} - ${ptsAgainst} (Penalty ${penaltyFor} - ${penaltyAgainst})";

  static m79(ptsFor, ptsAgainst) => "Playing ${ptsFor} - ${ptsAgainst}";

  static m80(ptsFor, ptsAgainst, overtimeFor, overtimeAgainst) =>
      "Loss ${ptsFor} - ${ptsAgainst} (Overtime ${overtimeFor} - ${overtimeAgainst})";

  static m81(ptsFor, ptsAgainst, overtimeFor, overtimeAgainst, penaltyFor,
          penaltyAgainst) =>
      "Loss ${ptsFor} - ${ptsAgainst} (Overtime ${overtimeFor} - ${overtimeAgainst})(Penalty ${penaltyFor} - ${penaltyAgainst})";

  static m82(ptsFor, ptsAgainst, penaltyFor, penaltyAgainst) =>
      "Loss ${ptsFor} - ${ptsAgainst} (Penalty ${penaltyFor} - ${penaltyAgainst})";

  static m83(ptsFor, ptsAgainst) => "Loss ${ptsFor} - ${ptsAgainst}";

  static m84(ptsFor, ptsAgainst, overtimeFor, overtimeAgainst) =>
      "Tie ${ptsFor} - ${ptsAgainst} (Overtime ${overtimeFor} - ${overtimeAgainst})";

  static m85(ptsFor, ptsAgainst, overtimeFor, overtimeAgainst, penaltyFor,
          penaltyAgainst) =>
      "Tie ${ptsFor} - ${ptsAgainst} (Overtime ${overtimeFor} - ${overtimeAgainst})(Penalty ${penaltyFor} - ${penaltyAgainst})";

  static m86(ptsFor, ptsAgainst, penaltyFor, penaltyAgainst) =>
      "Tie ${ptsFor} - ${ptsAgainst} (Penalty ${penaltyFor} - ${penaltyAgainst})";

  static m87(ptsFor, ptsAgainst) => "Tie ${ptsFor} - ${ptsAgainst}";

  static m88(ptsFor, ptsAgainst, overtimeFor, overtimeAgainst) =>
      "Win ${ptsFor} - ${ptsAgainst} (Overtime ${overtimeFor} - ${overtimeAgainst})";

  static m89(ptsFor, ptsAgainst, overtimeFor, overtimeAgainst, penaltyFor,
          penaltyAgainst) =>
      "Win ${ptsFor} - ${ptsAgainst} (Overtime ${overtimeFor} - ${overtimeAgainst})(Penalty ${penaltyFor} - ${penaltyAgainst})";

  static m90(ptsFor, ptsAgainst, penaltyFor, penaltyAgainst) =>
      "Win ${ptsFor} - ${ptsAgainst} (Penalty ${penaltyFor} - ${penaltyAgainst})";

  static m91(ptsFor, ptsAgainst) => "Win ${ptsFor} - ${ptsAgainst}";

  static m92(points, blocks, steals) =>
  ...
  static m97(time, endTime, tzShortName) =>
      "Practice ${time} - ${endTime} (${tzShortName})";

  static m98(time, endTime) => "NOW! Practice ${time} - ${endTime}";

  static m99(time, endTime, tzShortName) =>
      "NOW! Practice ${time} - ${endTime} (${tzShortName})";
  ...
  static _notInlinedMessages(_) => <String, Function>{
        ...
        "Add Team": MessageLookupByLibrary.simpleMessage("Add Team"),
        "Add Tournamwent":
            MessageLookupByLibrary.simpleMessage("Add Tournamwent"),
        "Add club member":
            MessageLookupByLibrary.simpleMessage("Add club member"),
        "Add game": MessageLookupByLibrary.simpleMessage("Add game"),
        ...
        "Archived Teams":
            MessageLookupByLibrary.simpleMessage("Archived Teams"),
        "Are you sure you want to add a player with no email?":
        ...
        "Attendence is from team":
            MessageLookupByLibrary.simpleMessage("Attendence is from team"),
        ...
        "Contact for the opponent":
            MessageLookupByLibrary.simpleMessage("Contact for the opponent"),
        "Contact phone number":
            MessageLookupByLibrary.simpleMessage("Contact phone number"),
        "Copy details from":
            MessageLookupByLibrary.simpleMessage("Copy details from"),
        "Create": MessageLookupByLibrary.simpleMessage("Create"),
        ...
        "Current team season":
            MessageLookupByLibrary.simpleMessage("Current team season"),
        ...
        "Delete News Item":
            MessageLookupByLibrary.simpleMessage("Delete News Item"),
        "Delete Player": MessageLookupByLibrary.simpleMessage("Delete Player"),
        "Delete admin invite":
            MessageLookupByLibrary.simpleMessage("Delete admin invite"),
        ...
        "Delete opponent":
            MessageLookupByLibrary.simpleMessage("Delete opponent"),
        "Delete special event":
            MessageLookupByLibrary.simpleMessage("Delete special event"),
        "Delete training":
            MessageLookupByLibrary.simpleMessage("Delete training"),
        "Description": MessageLookupByLibrary.simpleMessage("Description"),
        "Detailed Description":
            MessageLookupByLibrary.simpleMessage("Detailed Description"),
        "Details": MessageLookupByLibrary.simpleMessage("Details"),
        "Details of the place":
            MessageLookupByLibrary.simpleMessage("Details of the place"),
        "Divison": MessageLookupByLibrary.simpleMessage("Divison"),
        "Do you want to reset the timer to zero?":
            MessageLookupByLibrary.simpleMessage(
                "Do you want to reset the timer to zero?"),
        "Do you want to start the game?": MessageLookupByLibrary.simpleMessage(
            "Do you want to start the game?"),
        "Don\'t Panic": MessageLookupByLibrary.simpleMessage("Don\'t Panic"),
        "Don\'t track attendence":
            MessageLookupByLibrary.simpleMessage("Don\'t track attendence"),
        ...
        "Email Preferences":
            MessageLookupByLibrary.simpleMessage("Email Preferences"),
        ...
        "Foul Technical":
            MessageLookupByLibrary.simpleMessage("Foul Technical"),
        ...
        "Information about the coach":
            MessageLookupByLibrary.simpleMessage("Information about the coach"),
        "Invalid URL": MessageLookupByLibrary.simpleMessage("Invalid URL"),
        "Invited as an Administrator":
            MessageLookupByLibrary.simpleMessage("Invited as an Administrator"),
        "Invited to team":
            MessageLookupByLibrary.simpleMessage("Invited to team"),
        ...
        "League the team is playing in": MessageLookupByLibrary.simpleMessage(
            "League the team is playing in"),
        "League/Tournaments":
            MessageLookupByLibrary.simpleMessage("League/Tournaments"),
        ...
        "Minutes before game":
            MessageLookupByLibrary.simpleMessage("Minutes before game"),
        "Minutes to arrive before game": MessageLookupByLibrary.simpleMessage(
            "Minutes to arrive before game"),
        ...
        "Name can only contain alphanumerical characters.":
            MessageLookupByLibrary.simpleMessage(
                "Name can only contain alphanumerical characters."),
        "Name of the coach":
            MessageLookupByLibrary.simpleMessage("Name of the coach"),
        "Name of the opponent.":
            MessageLookupByLibrary.simpleMessage("Name of the opponent."),
        "Need to be an administrator":
            MessageLookupByLibrary.simpleMessage("Need to be an administrator"),
        "Need to have a subject":
            MessageLookupByLibrary.simpleMessage("Need to have a subject"),
        "Need to select a place":
            MessageLookupByLibrary.simpleMessage("Need to select a place"),
        "Need to select a role":
            MessageLookupByLibrary.simpleMessage("Need to select a role"),
        "Needs Invite": MessageLookupByLibrary.simpleMessage("Needs Invite"),
        "New Divison Name":
            MessageLookupByLibrary.simpleMessage("New Divison Name"),
        "New Season Name":
            MessageLookupByLibrary.simpleMessage("New Season Name"),
        "New player name":
            MessageLookupByLibrary.simpleMessage("New player name"),
        "New player name of player in team":
            MessageLookupByLibrary.simpleMessage(
                "New player name of player in team"),
        ...
        "No account found for email or internal error occured":
            MessageLookupByLibrary.simpleMessage(
                "No account found for email or internal error occured"),
        ...
        "No games this season":
            MessageLookupByLibrary.simpleMessage("No games this season"),
        "No games to display, check filters":
            MessageLookupByLibrary.simpleMessage(
                "No games to display, check filters"),
        ...
        "No tournaments":
            MessageLookupByLibrary.simpleMessage("No tournaments"),
        ...
        "Notes for the game":
            MessageLookupByLibrary.simpleMessage("Notes for the game"),
        "Notes for the training":
            MessageLookupByLibrary.simpleMessage("Notes for the training"),
        ...
        "Offical results don\'t match": MessageLookupByLibrary.simpleMessage(
            "Offical results don\'t match"),
        "On changes to games/events":
            MessageLookupByLibrary.simpleMessage("On changes to games/events"),
        "Opponent": MessageLookupByLibrary.simpleMessage("Opponent"),
        "Opponents with results":
            MessageLookupByLibrary.simpleMessage("Opponents with results"),
        "Opponents without results":
            MessageLookupByLibrary.simpleMessage("Opponents without results"),
        ...
        "Overtime Break":
            MessageLookupByLibrary.simpleMessage("Overtime Break"),
        ...
        "Place notes, ie court #":
            MessageLookupByLibrary.simpleMessage("Place notes, ie court #"),
        "Player": MessageLookupByLibrary.simpleMessage("Player"),
        "Player Name": MessageLookupByLibrary.simpleMessage("Player Name"),
        "Player email address":
            MessageLookupByLibrary.simpleMessage("Player email address"),
        "Players": MessageLookupByLibrary.simpleMessage("Players"),
        "Please choose a gender.":
            MessageLookupByLibrary.simpleMessage("Please choose a gender."),
        "Please choose a password.":
            MessageLookupByLibrary.simpleMessage("Please choose a password."),
        "Please choose a sport.":
            MessageLookupByLibrary.simpleMessage("Please choose a sport."),
        "Please choose an opponent.":
            MessageLookupByLibrary.simpleMessage("Please choose an opponent."),
        "Please fix the items outlined in red":
            MessageLookupByLibrary.simpleMessage(
                "Please fix the items outlined in red"),
        "Points": MessageLookupByLibrary.simpleMessage("Points"),
        "Practice": MessageLookupByLibrary.simpleMessage("Practice"),
        "Previous Seasons":
            MessageLookupByLibrary.simpleMessage("Previous Seasons"),
        "Pts": MessageLookupByLibrary.simpleMessage("Pts"),
        "RBs": MessageLookupByLibrary.simpleMessage("RBs"),
        "REMOVE FROM TEAM":
            MessageLookupByLibrary.simpleMessage("REMOVE FROM TEAM"),
        ...
        "Season name is required":
            MessageLookupByLibrary.simpleMessage("Season name is required"),
        ...
        "Select opponent":
            MessageLookupByLibrary.simpleMessage("Select opponent"),
        ...
        "Send to yourself":
            MessageLookupByLibrary.simpleMessage("Send to yourself"),
        ...
        "Special Events":
            MessageLookupByLibrary.simpleMessage("Special Events"),
        "Start Game": MessageLookupByLibrary.simpleMessage("Start Game"),
        "Start Game - Breaks":
            MessageLookupByLibrary.simpleMessage("Start Game - Breaks"),
        "Stats": MessageLookupByLibrary.simpleMessage("Stats"),
        ...
        "Technical Foul":
            MessageLookupByLibrary.simpleMessage("Technical Foul"),
        ...
        "Timer count up":
            MessageLookupByLibrary.simpleMessage("Timer count up"),
        "To setup a club for a team you need to be an administrator for both the club and for the team.  This will let you connect the both together.  Once connected all administators of the club will also be adminstragtors for the team.":
            MessageLookupByLibrary.simpleMessage(
                "To setup a club for a team you need to be an administrator for both the club and for the team.  This will let you connect the both together.  Once connected all administators of the club will also be adminstragtors for the team."),
        "Tournament": MessageLookupByLibrary.simpleMessage("Tournament"),
        "Track attendence":
            MessageLookupByLibrary.simpleMessage("Track attendence"),
        "Training": MessageLookupByLibrary.simpleMessage("Training"),
        "Training end": MessageLookupByLibrary.simpleMessage("Training end"),
        "Training notes":
            MessageLookupByLibrary.simpleMessage("Training notes"),
        "Training times":
            MessageLookupByLibrary.simpleMessage("Training times"),
        ...
        "Unable to load games":
            MessageLookupByLibrary.simpleMessage("Unable to load games"),
        "Uniform": MessageLookupByLibrary.simpleMessage("Uniform"),
        "Uniform to wear":
            MessageLookupByLibrary.simpleMessage("Uniform to wear"),
        "Unknown": MessageLookupByLibrary.simpleMessage("Unknown"),
        "Until": MessageLookupByLibrary.simpleMessage("Until"),
        "Upcoming games/events":
            MessageLookupByLibrary.simpleMessage("Upcoming games/events"),
        "Upload Video": MessageLookupByLibrary.simpleMessage("Upload Video"),
        "Use the results of the offical game for this game?":
            MessageLookupByLibrary.simpleMessage(
                "Use the results of the offical game for this game?"),
        "Username is empty.":
        ...
        "You must expect great things of yourself before you can do them.":
            MessageLookupByLibrary.simpleMessage(
                "You must expect great things of yourself before you can do them."),
        "You must have some players in a season to be able to create a game.":
            MessageLookupByLibrary.simpleMessage(
                "You must have some players in a season to be able to create a game."),
        "Your email address":
        ...
        "gameResultOfficialBreakout": m39,
