...
/**
 * Created by pinkfishfrog on 3/8/18.
 */

public enum FlutterPlacesTypeEnum {
    TYPE_OTHER(0, "other"),
    ...
    private static class Indexer {
        private static SparseArray<FlutterPlacesTypeEnum> index = new SparseArray<>();
    }

    FlutterPlacesTypeEnum(int id, String label) {
        this.label = label;
    ...
    public static FlutterPlacesTypeEnum findByTypeId(Integer id) {
        FlutterPlacesTypeEnum typeEnum = Indexer.index.get(id);
