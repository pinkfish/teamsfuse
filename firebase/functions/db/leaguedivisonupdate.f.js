...
exports = module.exports = functions.firestore.document('/LeagueDivision/{leagueId}').onUpdate((inputData, context) => {
    const finalRet = [];
...
// Handle the creation case as well, so if we create a game
// with a specific result we update the team values.
exports = module.exports = functions.firestore.document('/LeagueDivision/{leagueId}').onCreate((snap, context) => {
