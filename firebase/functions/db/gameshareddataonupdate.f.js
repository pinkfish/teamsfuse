...
exports = module.exports = functions.firestore.document("/GamesShared/{gameid}")
    .onWrite((inputData, context) => {
        ...
        if (data.officialResult !== null &&
            ...
            if (previousData === null ||
                ...
                finalRet.push(Promise.all([
                    ...
                    var ret = [];
                    if (!foundHome) {
                        ret.push(createGame.createGameFromShared(
                            inputData.after,
                            homeDoc
                        ));
                    }
        ...
        if (data.officialResult !== null &&
            ...
            var bits = [];
            bits.push(db.collection('GamesShared')
                    ...
                    for (var index in snapshot.docs) {
                        ...
                        if (doc.data().officialResult.homeTeamUid === homeUid ||
                            ...
                            if (doc.data().officialResult.scores !== null) {
                                // Add up the scores.
                                for (var period in Object.keys(doc.data().officialResult.scores)) {
                        ...
                        if (doc.data().officialResult.awayTeamUid === homeUid ||
                            ...
                            if (doc.data().officialResult.scores !== null) {
                                // Add up the scores.
                                for (var innerPeriod in Object.keys(doc.data().officialResult.scores)) {
                                    var innerPerData = doc.data().officialResult.scores[innerPeriod];
